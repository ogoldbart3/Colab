...
/**
 * LocalStorageHandler is responsible for storing locally history of chat
 * messages and information about other students.
 * 
 * @author Pawel
 * 
 */
public class LocalStorageHandler extends SQLiteOpenHelper {
	...
	private static final String DATABASE_NAME = "ColabDB.db";
	private static final int DATABASE_VERSION = 1;

	private static final String _ID = "_id";
	private static final String TABLE_NAME_MESSAGES = "colab_chat_messages";
	...
	private static final String TABLE_MESSAGE_CREATE = "CREATE TABLE "
			...
			+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + MESSAGE_RECEIVER
			+ " VARCHAR(25), " + MESSAGE_SENDER + " VARCHAR(25), "
	...
	/**
	 * Get history of chat messages between sender and receiver.
	 * @param sender
	 * @param receiver 
